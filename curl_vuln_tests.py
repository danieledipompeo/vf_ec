...
def get_target_files_from_fix():
    ...
    """
    print(f"🔍 Analyzing FIX_COMMIT {FIX_COMMIT[:8]} to identify target files...")
...
def main():
    ...
    if not target_files:
        print("⚠️  No .c files found in the fix commit. Cannot proceed.")
        return
    print(f"🎯 Target files (from fix): {target_files}")

    # 2. Switch to Vulnerable Commit and Build
    print(f"🛠️  Phase 1: Building VULN version ({VULN_COMMIT[:8]}) with Coverage...")
    ...
    print(f"🧪 Phase 2: Running {len(test_ids)} tests on VULN commit...")
    ...
    with open(OUTPUT_CSV, "a", newline="") as csvfile:
        ...
        for tid in test_ids:
            ...
            if intersection:
                ...
                print(f"✅ Test {tid} touched target file: {intersection}")
